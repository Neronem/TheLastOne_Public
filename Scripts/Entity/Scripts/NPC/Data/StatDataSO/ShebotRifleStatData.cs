...
{
    [CreateAssetMenu(fileName = "Stats", menuName = "ScriptableObjects/Entity/Enemy/ShebotRifleStatData")]
    public class ShebotRifleStatData : EntityStatData, IDetectable, IAttackable, IAlertable, IPatrolable
    {
        [Header("Range")] 
